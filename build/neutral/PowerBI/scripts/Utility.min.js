...
!function(a) {
    var b = function() {
        ...
        return b.prototype.showMessage = function(b, c) {
            ...
            var e = [];
            e[0] = this.createButton(InJs.Strings.dialogCloseActionLabel, function(a, b) {
                d.hideDialog();
            ...
            var j = new Array();
            h ? h.forEach(function(a, b, c) {
                j.push(i.createButton(a.label, function(b, c) {
                    i.hideDialog(), $.isFunction(g) && g(a.resultValue);
                }, null, a.cssClass, a.disabled));
            }) : 6 !== d ? j[0] = this.createButton(InJs.Strings.dialogCloseActionLabel, function(a, b) {
                i.hideDialog(), $.isFunction(g) && g(0);
            }) : j[0] = this.createButton(InJs.Strings.dialogRefreshPageActionLabel, function(a, b) {
                window.location.reload();
            }, null, "primary");
            var k = $("<div/>").text(c);
            this.addAdditionalErrorInfo(k, f), this.pushMessage(b || InJs.Strings.errorDialogTitle, null, k, j, e, null);
        }, b.prototype.showCustomDialog = function(a, b, c, d, e, f, g, h) {
            for (var i = [], j = 0; j < c.length; j++) {
                var k = c[j], l = k.cssClass;
                0 === j && (l += " primary"), i[j] = this.createButton(k.labelText, k.actionCallback, k.data, l, k.disabled);
            }
            return this.pushMessage(a, null, b, i, e, d, f, g, h), this._dialogContent;
            ...
            this._modalContainer.fadeTo(b.AnimationSpeedMs, 0, function() {
                ...
                c._modalDialogElement.removeClass(c._modalDialogCustomClass), c._modalContainer.removeClass(c._modalContainerCustomClass), 
            ...
            if (c) {
                ...
                b.append($("<br />")), b.append(g), b.find(".showAdditionalDetailsLink").on(a.DOMConstants.mouseClickEventName, function(a) {
                    d.updatePosition(!0);
                });
            }
        }, b.prototype.pushMessage = function(a, b, d, e, f, g, h, i, j) {
            "undefined" == typeof f && (f = !0), "undefined" == typeof i && (i = ""), "undefined" == typeof j && (j = "");
            var k = new c();
            k.titleText = a, k.messageText = b, k.dialogContent = d, k.dialogButtons = e, k.onDialogDisplayed = g, 
            k.isDismissable = f, k.dialogCssClass = i, k.containerCssClass = j, this._messageQueue.push(k), 
            !this._messageCurrentlyShown && this._isReady && this.showDialogInternal(this._messageQueue.shift(), h);
            ...
            c.dialogCssClass && (this._modalDialogElement.addClass(c.dialogCssClass), this._modalDialogCustomClass = c.dialogCssClass), 
            c.containerCssClass && (this._modalContainer.addClass(c.containerCssClass), this._modalContainerCustomClass = c.containerCssClass);
            ...
            return i.attr("value", c), i.on(a.DOMConstants.mouseClickEventName, function(a) {
    ...
    var c = function() {
        function a() {
            ...
            this.onDialogDisplayed = null, this.isDismissable = !0, this.dialogCssClass = null, 
...
!function(a) {
    ...
    !function(b) {
        function c(a) {
            var b, c = new Date(a);
            return "Invalid Date" === c.toString() ? null : (b = c.getTimezoneOffset(), c.setMinutes(c.getMinutes() + b), 
            c);
        }
        function d(b) {
            a.Utility.throwIfNullOrEmptyString(b, null, "deserializeDate", "Cannot deserialize empty string"), 
            a.Utility.throwIfNotTrue(0 === b.indexOf(f) && a.StringExtensions.endsWith(b, g), null, "deserializeDate", "Cannot deserialize empty string");
            var c = b.substring(f.length, b.length - g.length);
            a.Utility.throwIfNotTrue(/^\-?\d+$/.test(c), null, "deserializeDate", "Cannot deserialize invalid date");
            var d = parseInt(c, 10);
            return a.Utility.throwIfNotTrue(!isNaN(d), null, "deserializeDate", "Cannot deserialize invalid date"), 
            new Date(d);
        }
        function e(a) {
            try {
        ...
        var f = "/Date(", g = ")/";
        b.parseIsoDate = c, b.deserializeDate = d, b.tryDeserializeDate = e;
...
!function(a) {
    ...
    !function(a) {
        ...
        function r(a, b, c, d, e) {
            if (0 === c || 0 === e) return a >= b && b + c >= a ? d : NaN;
            var f = (a - b) / c, g = d + f * e;
            return g;
        }
        function s(a) {
...
!function(a) {
    ...
    !function(a) {
        function b() {
            l || (l = $("<span/>"), $("body").append(l), m = d3.select($("body").get(0)).append("svg").style({
                height: "0px",
                width: "0px",
                position: "absolute"
            }).append("text"), n = $("<canvas/>").get(0).getContext("2d"));
        }
        function c(a) {
...
!function(a) {
    var b = function() {
        ...
        return b.constructAdditionalErrorInfoBlock = function(c, d, e, f, g, h) {
            ...
            e.on(jsCommon.DOMConstants.mouseClickEventName, function(a) {
...
!function(a) {
    !function(a) {
        ...
        a[a.Forbidden = 403] = "Forbidden", a[a.RequestEntityTooLarge = 413] = "RequestEntityTooLarge";
...
!function(a) {
    var b = function() {
        function a() {}
        return a.removeInvalidCharacters = function(b) {
            for (var c, d = 0, e = 0, f = b.length; f > e; e++) a.isValidXmlCharacter(b, e) || ("undefined" == typeof c && (c = ""), 
            d !== e && (c += b.substring(d, e)), d = e + 1);
            return "undefined" == typeof c ? b : (d <= b.length - 1 && (c += b.substring(d, b.length)), 
            c);
        }, a.isValidXmlCharacter = function(b, c) {
            var d = b.charCodeAt(c);
            return d === a.TabCharCode || d === a.NewLineCharCode || d === a.CarriageReturnCharCode || d >= 32 && 55295 >= d || d >= 57344 && 65533 >= d || d >= 65536 && 1114111 >= d;
        }, a.TabCharCode = 9, a.NewLineCharCode = 10, a.CarriageReturnCharCode = 13, a;
    }();
    a.XmlUtility = b;
}(jsCommon || (jsCommon = {}));
...
!function(a) {
    var b = function() {
        ...
        return b.prototype.toString = function() {
            var c = "";
            return c += a.StringExtensions.format("{0} ({1}): {2}", b.traceTypeStrings[this.type], this.timeStamp.toUTCString(), this.text), 
            this.requestId && (c += "\n(Request id: " + this.requestId + ")"), c;
...
!function(a) {
    !function(a) {
        ...
        a[a.RequestEntityTooLarge = 413] = "RequestEntityTooLarge";
    }(a.HttpStatusCode || (a.HttpStatusCode = {}));
    a.HttpStatusCode;
}(powerbi || (powerbi = {}));
